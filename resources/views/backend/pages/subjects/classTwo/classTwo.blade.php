        ...
        <div class="breadcrumbs">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <form action="{{route('add-subject-two')}}" method="post">
                            {{csrf_field()}}
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                @foreach($subjectTwo as $key=>$two)
                                    <tr>
                                        <td>{{++$key}}</td>
                                        <td>{{$two->subject}}</td>
                                        <td>{{$two->desc}}</td>
                                        <td>
                                            <a href="{{route('delete-subject-two').'/'.$two->id}}" onclick="return confirm('are you sure to delete?')" class="btn btn-outline-danger btn-sm"><i class="fa fa-trash-o"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
