        ...
        <div class="breadcrumbs">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <form action="{{route('add-subject-nine')}}" method="post">
                            {{csrf_field()}}
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                @foreach($subjectNine as $key=>$nine)
                                    <tr>
                                        <td>{{++$key}}</td>
                                        <td>{{$nine->subject}}</td>
                                        <td>{{$nine->desc}}</td>
                                        <td>
                                            <a href="{{route('delete-subject-nine').'/'.$nine->id}}" onclick="return confirm('are you sure to delete?')" class="btn btn-outline-danger btn-sm"><i class="fa fa-trash-o"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
