                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-10">
                            ...
                            <form action="{{route('edit-studentEight-action')}}" method="post" enctype="multipart/form-data">
                                @csrf
                        ...
                        <div class="col-md-2">
                            <img src="{{url('lib/uploads/classes/classEight/'.$studentData->image)}}" id="target_image" alt="" class="g-header__profile-photo rounded-circle" style="height: 130px; width: 130px; float: left;  margin-left: 5px; border-radius: 50%; margin-top: 30px;">
                        </div>
                    </div>
                </div>
