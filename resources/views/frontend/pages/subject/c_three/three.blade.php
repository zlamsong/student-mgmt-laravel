            ...
            <div class="container">
                <div class="probootstrap-section probootstrap-section-colored">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 text-left section-heading probootstrap-animate">
                                <h1>class :THREE | Subjects : {{$total}}</h1>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="probootstrap-text probootstrap-animate">
                        @if(count($threeData) > 0)
                            @foreach($threeData as $three)
                                ...
                                <div class="col-md-12 mx-auto probootstrap-animate">
                                    <div class="probootstrap-featured-news-box">
                                        <div class="probootstrap-text" >
                                            ...
                                            <h3><b>{{strtoupper($three->subject)}}</b></h3>
                                            <hr>
                                            <p>{{str_limit($three->desc, 270)}}</p>
                                            <a href="{{route('subject-three-read-more').'/'.$three->id}}" class="btn btn-info btn-sm">Read more..</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
