            ...
            <div class="container">
                <div class="probootstrap-section probootstrap-section-colored">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 text-left section-heading probootstrap-animate">
                                <h1>class : EIGHT | Subjects : {{$total}}</h1>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="probootstrap-text probootstrap-animate">
                        @if(count($eightData) > 0)
                            @foreach($eightData as $eight)
                                ...
                                <div class="col-md-12 mx-auto probootstrap-animate">
                                    <div class="probootstrap-featured-news-box">
                                        <div class="probootstrap-text" >
                                            ...
                                            <h3><b>{{strtoupper($eight->subject)}}</b></h3>
                                            <hr>
                                            <p>{{str_limit($eight->desc, 270)}}</p>
                                            <a href="{{route('subject-eight-read-more').'/'.$eight->id}}" class="btn btn-info btn-sm">Read more..</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
