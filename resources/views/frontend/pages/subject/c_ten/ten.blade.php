                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 text-left section-heading probootstrap-animate">
                                <h1>class : TEN | Subjects : {{$total}}</h1>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-md-12 mx-auto probootstrap-animate">
                                    <div class="probootstrap-featured-news-box">
                                        <div class="probootstrap-text" >
                                            ...
                                            <h3><b>{{strtoupper($ten->subject)}}</b></h3>
                                            <hr>
                                            <p>{{str_limit($ten->desc, 270)}}</p>
                                            <a href="{{route('subject-ten-read-more').'/'.$ten->id}}" class="btn btn-info btn-sm">Read more..</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
