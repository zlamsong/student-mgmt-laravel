                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="probootstrap-flex-block">
                                ...
                                <div class="probootstrap-image probootstrap-animate" style="background-image: url({{url('svg/gradeOne.jpg')}})">
                                ...
                                <div class="col-md-12 mx-auto probootstrap-animate">
                                    <div class="probootstrap-featured-news-box">
                                        <div class="probootstrap-text" >
                                            ...
                                            <div>
                                                <form method="get">
                                                    <input type="text" id="searchOne" class="form-control" placeholder="Search Notes ..." >
                                                </form>
                                            </div>
                                            <br>
                                            <!--/data search bar-->
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                @foreach($oneData as $key=>$one)
                                                    <tr>
                                                        <td>{{++$key}}</td>
                                                        <td>
                                                            <img src="{{url('lib/uploads/classes/classOne/'.$one->image)}}" class="g-header__profile-photo rounded-circle" style="height: 50px; width: 50px; float: left;  margin-left: 5px; border-radius: 50%;">
                                                        </td>
                                                        <td>
                                                            {{$one->first_name}}
                                                        </td>
