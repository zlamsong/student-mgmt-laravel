                                    ...
                                    <div class="probootstrap-featured-news-box">
                                        <div class="probootstrap-text" >
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                @foreach($threeData as $key=>$three)
                                                    <tr>
                                                        <td>{{++$key}}</td>
                                                        <td>
                                                            <img src="{{url('lib/uploads/classes/classThree/'.$three->image)}}" class="g-header__profile-photo rounded-circle" style="height: 50px; width: 50px; float: left;  margin-left: 5px; border-radius: 50%;">
                                                        </td>
                                                        <td>
                                                            {{$three->first_name}}
                                                        </td>
